...
namespace SportO.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            player = _context.Players.Include(p => p.Phone).FirstOrDefault();
            return View(player);
        }
        ...
        public async Task<IActionResult> Create(Player player)
        {
            ...
            ViewData["PhoneId"] = new SelectList(_context.Phones, "Id", "phoneNumber", player.PhoneId);
            return View(player);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,firstName,lastName,accountActive,PhoneId")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
